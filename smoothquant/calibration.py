...
def get_static_decoder_layer_scales(model,
    ...
    for idx in range(model.config.num_hidden_layers):
        ...
        scale_dict["attn_input_scale"] = act_dict[
            f"transformer.h.{idx}.self_attention.query_key_value"]['input'] / 127
        scale_dict["qkv_output_scale"] = act_dict[
            f"transformer.h.{idx}.self_attention.query_key_value"]['output'] / 127
        ...
        scale_dict["out_input_scale"] = act_dict[
            f"transformer.h.{idx}.self_attention.dense"]['input'] / 127
        scale_dict["fc1_input_scale"] = act_dict[
            f"transformer.h.{idx}.mlp.dense_h_to_4h"]['input'] / 127
        scale_dict["fc2_input_scale"] = act_dict[
            f"transformer.h.{idx}.mlp.dense_4h_to_h"]["input"] / 127
